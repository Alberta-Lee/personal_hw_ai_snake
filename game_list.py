...
class Game_list():
    ...
    def show_menu(self):
        ...
        self.main.draw_text('A* Snake Game',(window_w//2,y//3),size=50,center='center')
        self.main.draw_text('Author:RuiyuLi',(window_w//2,y//3+60),size=24,center='center',font_name='arial')
        self.main.draw_text('Email:ruiyli@stu.xidian.edu.cn',(window_w//2,y//3+90),size=24,center='center',font_name='arial')
        # 俄罗斯方块
